...
重要提示：本软件仅供教育和信息目的使用。它不应被视为财务建议或作为任何具体投资决策的推荐。

使用本工具涉及重大财务风险。网格交易和其他投资策略可能导致巨大损失，尤其是在市场波动较大的情况下。本软件的作者不对使用本工具而导致的任何财务损失或损害负责。
...
4. 我们鼓励您在做出任何投资决策之前，寻求持牌金融专业人士的建议。

作者不保证本工具提供的信息的准确性、可靠性或完整性。市场条件可能迅速变化，过去的表现并不保证未来的结果。
